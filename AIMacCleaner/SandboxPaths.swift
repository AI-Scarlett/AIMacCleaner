...
class SandboxPaths {
    ...
    var marketplaceCatalogPath: String { dataDirectory + "/marketplace_storefront_v1.json" }
    var marketplaceCatalogSignaturePath: String { dataDirectory + "/marketplace_storefront_v1.json.sig" }
    var marketplaceCatalogMetadataPath: String { dataDirectory + "/marketplace_storefront_metadata_v1.json" }
