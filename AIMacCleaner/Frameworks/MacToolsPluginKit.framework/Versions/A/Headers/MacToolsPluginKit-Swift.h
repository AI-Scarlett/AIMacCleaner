...
#ifndef MACTOOLSPLUGINKIT_SWIFT_H
#define MACTOOLSPLUGINKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MacToolsPluginKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17MacToolsPluginKit30PluginSettingsReorderTableView")
@interface PluginSettingsReorderTableView : NSTableView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (BOOL)canDragRowsWithIndexes:(NSIndexSet * _Nonnull)rowIndexes atPoint:(NSPoint)mouseDownPoint SWIFT_WARN_UNUSED_RESULT;
